...
export const AUTH_ENDPOINTS = {
  ...
  REQUEST_EMAIL_CHANGE: `${API_BASE_URL}/auth/request-email-change`,
  VERIFY_EMAIL_CHANGE: `${API_BASE_URL}/auth/verify-email-change`,
  CANCEL_EMAIL_CHANGE: `${API_BASE_URL}/auth/cancel-email-change`,
